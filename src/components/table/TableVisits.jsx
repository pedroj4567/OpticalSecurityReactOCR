...
const TableVisits = () => {
  ...
  return (
    <section className="w-[90%] mx-auto mt-10 flex flex-col">
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg border-purple-600">
        <table className="w-full text-sm text-left rtl:text-right border-[#522b5b] text-white ">
          <thead className="text-xs text-slate-100 uppercase  bg-[#522b5b] ">
            <tr>
            ...
            response && (
              <tbody className="border-purple-600">
                {response.visits.map((user) => {
                  ...
                  const formattedDate = `${dateAdmission.getFullYear()}-${
                    dateAdmission.getMonth() + 1
                  }-${dateAdmission.getDate()}`;

                  return (
                    <>
                      <tr className="bg-white border-b text-gray-700 dark:border-purple-600">
                        <th
                          scope="row"
                        ...
                        <td className="px-6 py-4">{user.model_vehicle}</td>
                        <td className="px-6 py-4 font-bold">
                          {user.license_plate_number}
                        </td>
                        <td className="px-6 py-4">{user.color_vehicle}</td>
                        <td className="px-6 py-4">{user.brand_vehicle}</td>
